...
function DashboardCard2() {
  return (
    <DashboardCardWrapper className={`bg-gray-70 ${styles.card}`}>
      <div className="font-bold text-lg mr-auto">Full report</div>
      <div className="flex-1 flex flex-col justify-center items-center">
        <div className="bg-gray-70 rounded-lg w-full mt-6">
          ...
          >
            <div className="h-full flex items-center justify-center flex-1 border-r border-text-light-secondary">
              Download Report
            </div>
            <div className="p-6">
